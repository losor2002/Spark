<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.util.List, losor.model.bean.Carta"%>
...
<html lang="it">
    <head>
        ...
        <title>Area Personale | Carte</title>
    </head>
                        ...
                        <div class="card card-body bg-dark border-light mb-3">
                            <div class="row">
                                ...
                                <div class="col-2 d-flex align-items-center justify-content-end">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_<%= carta.getNumero()%>">
                                        <img class="img-fluid" src="<%= contextPath%>/images/trash.svg" alt="trash">
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="modal fade" id="modal_<%= carta.getNumero()%>" tabindex="-1" aria-labelledby="ModalLabel_<%= carta.getNumero()%>" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered text-dark">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="ModalLabel_<%= carta.getNumero()%>">Conferma</h5>
                                ...
                                <div class="modal-footer">
                                  ...
                                  <form action="<%= contextPath%>/deleteCarta" method="post">
                                        <input type="hidden" name="numero" value="<%= carta.getNumero()%>">
