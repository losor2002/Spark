    ...
    <body class="bg-dark text-light">
        ...
        <div class="container">
            <div class="position-fixed top-50 start-50 translate-middle">
                ...
                <h2 class="text-center mb-3">numero d'ordine: <a class="text-decoration-none" href="<%= application.getContextPath()%>/dettagliOrdine?numFattura=${requestScope.numeroFattura}">${requestScope.numeroFattura}</a></h2>
